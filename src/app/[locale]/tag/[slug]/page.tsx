...
import { getByTag, getMostRead } from "@/server/dal/articles";
...
export default async function TagPage({
  ...
  const data = await getByTag(locale, slug, page);
  if (!data) notFound();
  ...
  return (
    ...
    >
      ...
      <Pagination page={page} hasNext={data.hasNext} basePath={`/tag/${slug}`} />
    </PublicMain>
  );
}
